...
export const RowHeightMediumIcon = (props: IconProps) => (
  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5h16M4 11h16M4 17h16" />
  </svg>
);
...
export const RowHeightExtraTallIcon = (props: IconProps) => (
  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 3h16M4 13h16" />
  </svg>
);
