...
export function FilterDropdown({
  ...
  return (
    <>
      ...
      <div className="absolute top-full right-0 z-40 mt-1 w-96 rounded-lg border border-gray-200 bg-white py-3 shadow-lg">
        ...
        {localFilters.length === 0 ? (
          ...
          <div className="max-h-64 space-y-2 overflow-y-auto px-3">
                ...
                <div key={index} className="flex items-center gap-1.5">
                  ...
                  {needsValue && (
                    <input
                      ...
                      placeholder="value"
                      className="w-20 flex-1 rounded border border-gray-200 px-1.5 py-1 text-xs text-gray-700 outline-none focus:border-blue-400"
                    />
                  )}
        ...
        <div className="flex items-center gap-2 px-3 pt-2">
          <button
            onClick={addFilter}
            className="rounded-md border border-blue-300 px-2.5 py-1 text-xs font-medium text-blue-600 hover:bg-blue-50"
          >
            + Add condition
          </button>
        </div>
