...
type FieldCategory = "agent" | "standard";
...
const FIELD_TYPES: FieldType[] = [
  ...
  {
    id: "build-agent",
    name: "Build a field agent",
    type: "TEXT",
    category: "agent",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>,
    badge: "AI",
  },
  {
    id: "browse-catalog",
    ...
    type: "TEXT",
    category: "agent",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>,
    badge: "AI",
  },
  ...
  // Standard Fields
  {
    ...
    type: "TEXT",
    category: "standard",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>,
  },
  {
    id: "single-line-text",
    ...
    type: "TEXT",
    category: "standard",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16m-7 6h7" /></svg>,
  },
  {
    id: "long-text",
    name: "Long text",
  ...
  },
  {
    ...
    type: "TEXT",
    category: "standard",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" /></svg>,
  },
  {
    id: "checkbox",
    name: "Checkbox",
  ...
  },
  {
    ...
    type: "TEXT",
    category: "standard",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m-8-8h16M4 4h16M4 20h16" /></svg>,
  },
  {
    id: "button",
    name: "Button",
    type: "TEXT",
    category: "standard",
    icon: <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" /></svg>,
  },
];
      ...
      >
        ...
        <div className="max-h-96 overflow-y-auto px-4 py-3">
          ...
          {agentFields.length > 0 && (
            <div className="mb-4">
              <h3 className="mb-2 px-2 text-xs font-medium text-gray-500">Field agents</h3>
          ...
          {standardFields.length > 0 && (
            <div>
              <h3 className="mb-2 px-2 text-xs font-medium text-gray-500">Standard fields</h3>
              <div className="space-y-1">
