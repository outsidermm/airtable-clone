...
import { ArrowLeftIcon, BellIcon, HomeIcon, QuestionIcon } from "~/components/icons";
  ...
  return (
    <aside className="flex h-full w-16 flex-col items-center border-r border-gray-200 bg-white py-3">
      ...
      >
        ...
        />
        <ArrowLeftIcon className="h-5 w-5 absolute opacity-0 group-hover:opacity-100 transition-opacity" />
      </Link>
